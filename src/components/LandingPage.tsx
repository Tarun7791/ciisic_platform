...
export default function LandingPage({ onLoginClick, onQuickLogin }: LandingPageProps) {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 font-sans">
      ...
      <div className="bg-slate-950 text-white py-2.5 px-4 text-center text-[9px] sm:text-[10px] font-semibold tracking-wider sm:tracking-widest border-b border-slate-900 uppercase break-words leading-relaxed">
      ...
      <header className="relative bg-white border-b border-slate-250/85 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-14 md:py-20 flex flex-col lg:flex-row items-center justify-between gap-10 relative">
          <div className="max-w-2xl text-left">
            <div className="inline-flex items-center gap-1.5 bg-orange-50 text-orange-700 px-2.5 py-0.5 rounded-md text-[11px] font-semibold tracking-wide uppercase mb-5 border border-orange-100 font-mono">
              <Cpu className="w-3.5 h-3.5 text-orange-500" /> Bridging Industry & Academia
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold tracking-tight text-slate-900 leading-tight mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3.5">
              <button
                ...
                className="bg-orange-500 hover:bg-orange-600 text-white font-semibold font-display px-5 py-3 rounded-lg shadow-sm hover:shadow-orange-200 transition-all flex items-center justify-center gap-2 text-xs uppercase tracking-wider"
              >
                Sign In to Platform <ArrowRight className="w-4 h-4" />
              </button>
              <a
                href="#how-it-works"
                className="bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold px-5 py-3 rounded-lg transition-all text-center text-xs font-display uppercase tracking-wider"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="bg-slate-900 text-white p-6 sm:p-8 rounded-xl shadow-xl w-full max-w-md relative border border-slate-800">
            <div className="absolute -top-3 -right-3 bg-orange-500 text-white px-2.5 py-0.5 rounded text-[9px] font-bold uppercase tracking-wider shadow">
              Interactive Sandbox
            </div>
      ...
      {/* Mission & Vision */}
      <section className="py-12 bg-slate-100/50" id="how-it-works">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-slate-200/80">
            <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 mb-2.5 flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center text-xs font-bold font-mono">1</span>
              Our Core Mission
            </h2>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-slate-200/80">
            <h2 className="text-base sm:text-lg font-display font-bold text-slate-900 mb-2.5 flex items-center gap-2">
              <span className="w-7 h-7 rounded-lg bg-orange-50 text-orange-600 flex items-center justify-center text-xs font-bold font-mono">2</span>
      ...
      <section className="py-12 sm:py-16 max-w-7xl mx-auto px-6">
        <div className="text-center max-w-xl mx-auto mb-10">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-display font-bold text-slate-900 mb-3">Unified Stakeholder Portal</h2>
